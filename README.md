...
[![Quality Score](https://img.shields.io/scrutinizer/g/iGusev/torrent.svg?style=flat-square)](https://scrutinizer-ci.com/g/iGusev/torrent)
...
``` bash
$ composer require league/torrent
```
